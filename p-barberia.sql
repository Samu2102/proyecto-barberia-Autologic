...
-- Tiempo de generación: 26-03-2026 a las 13:39:01
...
INSERT INTO `detalle_pagos` (`id_detalle_pago`, `id_venta`, `total`, `id_detalle_servicio`) VALUES
(1, 1, 35000.00, 1),
(2, 2, 22000.00, 2),
(3, 3, 47000.00, 3),
(4, 4, 22000.00, 4),
...
--
ALTER TABLE `detalle_pagos`
  MODIFY `id_detalle_pago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
